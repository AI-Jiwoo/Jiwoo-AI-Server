...
class TaxationChatbot(Chatbot):
    ...
    def get_taxation_response(self, business_id: int, user_input: str) -> str :
        ...
        try:
            ...
            relevant_info.extend(taxation_data.get("BusinessInfo", [])) 
            relevant_info.extend(taxation_data.get("Question", [])) 
            relevant_info.extend(taxation_data.get("TransactionFile", []))
            relevant_info.extend(taxation_data.get("IncomeTaxFile", []))
